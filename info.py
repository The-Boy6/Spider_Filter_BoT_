...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6045160821').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'New_Movies_Bots')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002452108731'))
